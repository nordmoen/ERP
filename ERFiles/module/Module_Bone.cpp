...
void Module_Bone::createControl() {
	...
	//control = controlFactory->createNewControlGenome(settings->controlType, settings, randomNum); // 0 is ANN
	//control = controlFactory->createNewControlGenome(1, settings, randomNum); // 0 is ANN
	control = controlFactory->createNewControlGenome(settings->controlType, settings, randomNum);
