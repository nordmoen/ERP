...
//	simLoadScene("scenes/ExcavatorScene.ttt");
	simLoadScene("scenes/DefaultERLight.ttt");
...
vector<float> Environment::fitnessFunction(MorphologyPointer morph1, MorphologyPointer morph2)
{
	cout << "This environment does not take a fitness function with two individuals" << endl;
	return vector<float>();
}
